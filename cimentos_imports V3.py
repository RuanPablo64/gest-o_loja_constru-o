...
#atualizações: adicionei uma função para limpar o terminal (evitando o uso de bibliotecas) e uma outra função para a logo do nome da loja ser chamado em todas as ocasiões
...
produtos = {
    # codigo chave (EAN/codigo de barras) : nome, preço, em estoque (observação: a disponibilidade do produto será importante no modulo Entregas)
    ...
    if decisao == "1":
        ...
        while decisao_entrega != "5":
            ...
            if decisao_entrega == "1":
                ...
                print("+-+-+-+-+-+-+-+-+-+-+-+-+-+-+")
                print()
                #nota importante: decidi fazer uma ligação entre o primeiro e o segundo modulo
                #a entrega so pode ser registrada caso o produto informado e o clinete que está pedindo a entrega estejam cadastrados no sistema
                #ademais, se o produto não estiver disponivel/em estoque, a entrega também não será feita
                #isso também occore na subcategoria de "status de entrega"(seria o atualizar desse modulo)
                ...
                if ean_produto in produtos and produtos[ean_produto][2] == "disponivel":
                    ...
                    if ean_produto not in produtos:
                        ...
                        print("o produto informado não está em estoque/disponivel no momento")
                        print()
                        sair = input("aperte <enter> para sair do sistema: ")
                ...
                if alteracao in entregas:
                    ...
                    if novo_produto_cadastrado in produtos and produtos[novo_produto_cadastrado][2] == "disponivel":
                        ...
                        if nova_senha_cliente in clientes:
                            ...
                            print()
                            sair = input("aperte <enter> para sair: ")
                    elif novo_produto_cadastrado not in produtos or produtos[novo_produto_cadastrado][2] != "disponivel":
                        if novo_produto_cadastrado not in produtos:
                            print("o produto informado não está cadastrado no sistema")
                            print()
                            sair = input("aperte <enter> para sair: ")
                        elif produtos[novo_produto_cadastrado][2] != "disponivel":
                            print("o produto informado não está em estoque/disponivel no momento")
                            print()
                            sair = input("aperte <enter> para sair: ")
